...
- [x] Lógica de Agendamento (Cálculo automático de `end_time` e slots de 30 min).
...
- [ ] Botão de integração real com o Google Calendar via API.
- [ ] Dashboard de Administrador (para ver o total de agendamentos da plataforma).
